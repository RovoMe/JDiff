...
public class Snake<T>
{
     ...
     *
     * @param isForward
     *         If set to true a forward comparison will be done; else a backward comparison
     * @param delta
     *         The difference in length between the first and the second object to compare
     */
     ...
     * @param M
     *         The index of the last element from the second object to compare
     * @param isForward
     *         The comparison direction; true for a forward comparison, false otherwise
     * @param xStart
     *         The x-position of the current node
     * @param yStart
     *         The y-position of the current node
     * @param aDeleted
     *         Defines the number of removed elements from the first object (right movements in the graph)
     * @param bInserted
     *         Defines the number of inserted elements from the second object (down movement in the graph)
     * @param diagonal
     *         Defines the number of equal elements in both objects for a given segment
     */
     ...
     *         The y-position of the current node
     * @param down
     *         Defines if insertion (down movement; true) or a deletion (right movement; false) should be done
     * @param diagonal
     *         Defines the number of equal elements in both objects for a given segment
     */
     ...
     *
     * @param isMiddle
     *         true indicates that this segment is a middle point, false that it is not a middle point
     */
